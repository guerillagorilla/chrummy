...
- Root contains the web UI (`index.html`, `styles.css`, `app.js`).
- `README.md` covers setup, controls, and a short rules summary.

## Setup, Run, and Dev Commands

- Install Node dependencies (none beyond Node itself).
- Run the prototype UI: `node dev_server.mjs` (or `npm run dev`).
